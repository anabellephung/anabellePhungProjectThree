const skincareProducts = {
  cleanser: [
    ...
    {
      title: 'iS Clinical Cleansing Complex',
      price: '$$$',
    ...
    {
      title: 'Sulwhasoo Gentle Cleansing Oil',
      price: '$$$',
      skinType: ['oily', 'dry', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'aging'],
    ...
    {
      title: 'Youth to the People Kale + Green Tea Spinach Vitamins Cleanser',
      price: '$$',
    ...
    {
      title: 'Biossance Squalane + Tea Tree Cleansing Gel',
      price: '$$',
    ...
    {
      title: 'Renee Rouleau Moisture Protecting Cleanser',
      price: '$$',
    ...
    {
      title: 'Then I Met You Living Cleansing Balm',
      price: '$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
    ...
    {
      title: 'Peach & Lily Power Calm Hydrating Gel Cleanser',
      price: '$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'First Aid Beauty Pure Skin Face Cleanser',
      price: '$$',
    ...
    {
      title: 'Banila Co Clean It Zero Original Cleansing Balm',
      price: '$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
    ...
    {
      title: 'CeraVe Salicylic Acid Cleanser',
      price: '$',
      skinType: ['sensitive'],
      skinGoal: ['brightening', 'acne'],
  ...
  exfoliator: [
    ...
    {
      title: 'TATCHA Rice Enzyme Powder',
      price: '$$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'anti-aging'],
    ...
    {
      title: 'Kate Somerville ExfoliKate Intensive Exfoliating Treatment',
      price: '$$$',
      skinType: ['oily', 'dry', 'combination', 'normal'],
      skinGoal: ['brightening', 'anti-aging'],
    ...
    {
      title: 'SkinCeuticals Micro-Exfoliating Scrub',
      price: '$$',
      skinType: ['oily', 'dry', 'combination', 'normal'],
      skinGoal: ['brightening', 'anti-aging'],
    ...
    {
      title: 'NEOGEN Bio-Peel Gauze Peeling Green Tea',
      price: '$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'Origins GinZing Refreshing Scrub Cleanser',
      price: '$$',
    ...
    {
      title: 'Paula’s Choice SKIN PERFECTING 2% BHA Liquid',
      price: '$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'DRMTLGY Microdermabrasion Scrub',
      price: '$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
    ...
    {
      title: 'The INKEY List PHA Toner',
      price: '$',
      skinType: ['sensitive'],
      skinGoal: ['brightening', 'acne'],
  ...
  serum: [
    ...
    {
      title: 'Benton Snail Bee Ultimate Serum',
      price: '$$',
      skinType: ['oily', 'dry', 'combination', 'normal'],
      skinGoal: ['brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'Beauty of Joseon Repair Serum',
      price: '$',
      skinType: ['dry', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
  ...
  faceCream: [
    ...
    {
      title: 'Drunk Elephant Protini Polypeptide Moisturizer',
      price: '$$$',
      skinType: ['oily', 'dry', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'Then I Met You Calming Tide Gel Cream',
      price: '$$',
      skinType: ['oily', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'Avène Cicalfate Restorative Skin Cream',
      price: '$$',
      skinType: ['oily', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
      whereToBuy: 'https://sokoglam.com/products/then-i-met-you-calming-tide-gel-cream',
    ...
    {
      title: 'Etude House Moistfull Collagen Cream',
      price: '$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['brightening', 'anti-aging'],
    ...
    {
      title: 'First Aid Beauty Ultra Repair Cream Intense Hydration',
      price: '$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'anti-aging'],
  ...
  sunscreen: [
    {
      title: 'Tatcha Silken Pore Perfecting Sunscreen Broad Spectrum SPF 35 PA++',
      price: '$$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['anit-aging'],
    ...
    {
      title: 'EltaMD UV Sport Broad-Spectrum SPF 50',
      price: '$$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'Shiseido Ultimate Sun Protector Lotion SPF 50+ Sunscreen',
      price: '$$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'Dr. Jart Every Sun Day Mineral Sunscreen SPF 50+',
      price: '$$$',
    ...
    {
      title: 'Supergoop! Glowscreen SPF 40 ',
      price: '$$$',
    ...
    {
      title: 'Biossance Squalane + Zinc Sheer Mineral Sunscreen',
      price: '$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'Dr. Oracle A-Thera Sunblock SPF 50',
      price: '$$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
    ...
    {
      title: 'A’PIEU Pure Block Daily Sun Cream',
      price: '$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'PURITO Centella Green Level Unscented Sun',
      price: '$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'Alba Facial Sheer Shield Sunscreen SPF 45',
      price: '$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
    ...
    {
      title: 'CeraVe Hydrating Sunscreen SPF 30 Face Sheer Tint',
      price: '$',
      skinType: ['oily', 'dry', 'sensitive', 'combination', 'normal'],
      skinGoal: ['hydration', 'brightening', 'acne', 'anti-aging'],
